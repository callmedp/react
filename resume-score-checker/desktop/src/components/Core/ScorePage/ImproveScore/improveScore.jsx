        ...
        <div className="improve-score__wrap">
          ...
          <div className="improve-score__rightPan">
            ...
            <div className="improve-score__rightPan__items">
              ...
              <a href={`${siteDomain}/services/resume-writing/63/`} className="btn btn-round-40 btn-outline-primary px-5 py-4 my-3"  onClick={() => handleEventClick('Resumewriting','Improvescore')}>Get details</a>
            </div>
            ...
            <div className="improve-score__rightPan__items">
              ...
              <a href={`${siteDomain}/resume-builder/`} className="btn btn-round-40 btn-outline-primary px-5 py-4 my-3" onClick={() =>handleEventClick('ResumeBuilder','Improvescore') }>Create now</a>
            </div>
            ...
            <div className="improve-score__rightPan__items d-lg-none d-xl-block">
              ...
              <a href={`${siteDomain}/cms/resume-format/1/`} className="btn btn-round-40 btn-outline-primary px-5 py-4 my-3" onClick={()=>handleEventClick('ResumeFormat','Improvescore')}>Explore now</a>
            </div>
