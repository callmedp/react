        ...
        <div className="resume-detail mt-5">
          ...
          <div className="resume-detail__contentWrap">
            <div className="resume-detail__content">
              ...
              {
                !(subSection['section_status']) ? <p><strong>Oops ! We weren't able to detect this section on your resume. Let our experts guide you with most-commonly used terms and best practices to make your resume ATS friendly.</strong></p> : subSection['section_message'] ? <p> {subSection['section_message']} </p> : null
              }
