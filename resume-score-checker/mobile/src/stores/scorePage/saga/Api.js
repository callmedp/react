...
const fileUpload = (data) => {
    ...
    // return {
    //     data :{'total_score': 32, 'section_score': [{'section_name': 'Format/Style', 'section_score': 2.0, 'section_total_score': 10, 'section_description': 'format style', 'section_status': 1, 'section_message': '<h3>New section msg added</h3>'}, {'section_name': 'Summary & Objective', 'section_score': 2.5, 'section_total_score': 10, 'section_description': 'summary', 'section_status': 0, 'section_message': 'Changed'}, {'section_name': 'Education Detail', 'section_score': 5.0, 'section_total_score': 10, 'section_description': 'education', 'section_status': 2, 'section_message': 'New section msg added'}, {'section_name': 'Work Experience', 'section_score': 6.0, 'section_total_score': 10, 'section_description': 'experience', 'section_status': 2, 'section_message': 'New section msg added'}, {'section_name': 'Contact Detail', 'section_score': 10.0, 'section_total_score': 30, 'section_description': 'New Description', 'section_status': 1, 'section_message': 'New section msg added'}, {'section_name': 'Skills', 'section_score': 7.0, 'section_total_score': 10, 'section_description': 'some description', 'section_status': 2, 'section_message': 'New section msg added'}], 'error_message': ''}
    // }
}
