        ...
        <div className="get-expert-help">
            <div className="container-box">
                ...
                <ul className="get-expert-help__list">
                    <li><a href="https://learning.shine.com/services/resume-writing/63/" style={{color:'grey'}}>Resume Writing</a></li>
                    <li><a href="https://learning.shine.com/services/resume-services/entry-level-freshers/pd-2052" style={{color:'grey'}}>Visual Resume</a></li>
                    <li><a href="https://learning.shine.com/services/resume-services/entry-level-freshers-4/pd-2553" style={{color:'grey'}}>International Resume</a></li>
                </ul>
            </div>
        </div>
    );
