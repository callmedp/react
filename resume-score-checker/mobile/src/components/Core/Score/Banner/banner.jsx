...
export default function Banner() {
    ...
    const data_progess_value = score * 100 / store_section_value?.reduce(reduced, 0)

    const scoreBasedDescription = () => {
        let scoreBased = data_progess_value
        switch(true){
            case scoreBased > 80 :
            ...
            <div className="container-box">
                ...
                <div className="score-banner__image">
                    <div className="score-banner__progressBar">
                        <div className="ko-progress-circle" data-progress={ data_progess_value ? Math.round(data_progess_value) : 0}>
