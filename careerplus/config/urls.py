...
urlpatterns += [
    ...
    url(r'^(m\/)?course/(?P<cat_slug>[\w-]+)/(?P<prd_slug>[\w-]+)/pd-(?P<pk>[\d]+)$',
        ProductDetailView.as_view(), name='course-detail'),
    url(r'^(m\/)?services/(?P<cat_slug>[\w-]+)/(?P<prd_slug>[\w-]+)/pd-(?P<pk>[\d]+)$',
        ProductDetailView.as_view(), name='service-detail'),
    url(r'^(m\/)?courses/', include('skillpage.urls', namespace='skillpage')),
...
urlpatterns += [
    ...
    url(r'^(m\/)?$', homepage_view.HomePageView.as_view(), name='homepage'),
    url(r'^console/', include('console.urls', namespace='console')),
    url(r'^(m\/)?shop/', include('shop.urls', namespace='shop')),
    url(r'^(m\/)?user/', include('users.urls', namespace='users')),
    url(r'^(m\/)?cms/', include('cms.urls', namespace='cms')),
    url(r'^(m\/)?article/', include('blog.urls', namespace='blog')),
    url(r'^(m\/)?cart/', include('cart.urls', namespace='cart')),
    url(r'^order/', include('order.urls', namespace='order')),
    url(r'^geolocation/', include('geolocation.urls', namespace='geolocation')),
    url(r'^(m\/)?payment/', include('payment.urls', namespace='payment')),
    ...
    url(r'^m/search/', include('search.urls', namespace='search')),
    url(r'^search/', include('search.urls', namespace='search')),
    url(r'^partner/', include('partner.urls')),
    url(r'^(m\/)?partner/', include('microsite.urls')),
    url(r'^(m\/)?linkdin/', include('linkedin.urls')),
    url(r'^(m\/)?register/$', RegistrationApiView.as_view(), name='register'),
    url(r'^(m\/)?login/$', LoginApiView.as_view(), name='login'),
    url(r'^(m\/)?logout/$', LogoutApiView.as_view(), name='logout'),
    url(r'^(m\/)?dashboard/', include('dashboard.urls', namespace='dashboard')),
    ...
    url(r'^(m\/)?', include('marketing.urls', namespace='marketing')),

    url(r'^(m\/)?about-us$',
        homepage_view.AboutUsView.as_view(), name='about-us'),
    url(r'^(m\/)?privacy-policy$',
    ...
    url(r'^(m\/)?article-categories/(?P<slug>[-\w]+)/$',
