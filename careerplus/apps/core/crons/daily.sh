...
/var/www/virtualenvs/learning/bin/python /var/www/site/learning/current/manage.py analytics_vidhya_status_update --settings=careerplus.config.settings_live
