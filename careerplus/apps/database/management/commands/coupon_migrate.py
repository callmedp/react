...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        sql = """
            ...
            FROM coupon_coupon 
            WHERE (coupon_coupon.active = True  AND coupon_coupon.valid_to >= '2017-08-01 00:00:00'  AND coupon_coupon.valid_from <= '2017-08-01 00:00:00' ) ORDER BY coupon_coupon.added_on DESC
            """
        cursor.execute(sql,{})
