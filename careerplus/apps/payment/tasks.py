...
@task
def make_logging_sk_request(tracking_product_id, product_tracking_mapping_id, tracking_id, action, position, trigger_point, u_id, utm_campaign, domain, referal_product, referal_sub_product):
    shine_api_url = settings.SHINE_API_URL
    req_dict, tracking_data = {} ,{}
    headers = dict()
