...
def unfeature():
    ...
    featured_orderitems = OrderItem.objects.filter(
        Q(order__status__in=[1, 3], product__type_flow=5, oi_status=28, product__sub_type_flow__in=[501, 503])|
        Q(order__status__in=[1, 3], product__type_flow=5, oi_status=5, product__sub_type_flow__in=[502]))
    featured_orderitems = featured_orderitems.select_related('order')
