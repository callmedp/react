...
class Test(AbstractAutoDate):
    ...
    course = models.ForeignKey(Product, null=True, blank=True,
                               related_name='testcourse',on_delete=models.PROTECT)
...
class Section(AbstractAutoDate):
    name = models.CharField(
        max_length=255, null=False, blank=False)
    duration = models.PositiveSmallIntegerField(default=0)
    test = models.ForeignKey(Test,blank=True, null=True,on_delete=models.PROTECT)
...
class Question(AbstractAutoDate):
    ...
    test = models.ForeignKey(Test, blank=True, null=True,on_delete=models.PROTECT)
    section = models.ForeignKey(Section, blank=True, null=True,on_delete=models.PROTECT)
    ...
    subsection = models.ForeignKey(SubSection,blank=True,null=True,on_delete=models.PROTECT)
