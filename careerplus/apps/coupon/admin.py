...
class CouponAdmin(admin.ModelAdmin):
    ...
    #     my_urls = [
    #         url(r'^generate_coupons/$', self.admin_site.admin_view(GenerateCouponsAdminView.as_view()),
...
#     template_name = 'coupon/generate_coupon.html'
