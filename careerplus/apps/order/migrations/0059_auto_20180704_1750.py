# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2018-07-04 12:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='order',
            name='status',
            field=models.PositiveSmallIntegerField(choices=[(0, 'Unpaid'), (1, 'Paid'), (2, 'InProcess'), (3, 'Closed'), (4, 'Archive'), (5, 'Cancelled')], default=0),
        ),
        migrations.AlterField(
