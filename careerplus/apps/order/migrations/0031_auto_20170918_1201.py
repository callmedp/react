# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-09-18 06:31
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('order', '0030_orderitem_expiry_date'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='coio_id',
            field=models.IntegerField(blank=True, editable=False, null=True, verbose_name='CP Order IO'),
        ),
        migrations.AlterField(
            model_name='orderitem',
            name='coi_id',
            field=models.IntegerField(blank=True, editable=False, null=True, verbose_name='CP OrderItem'),
        ),
    ]
