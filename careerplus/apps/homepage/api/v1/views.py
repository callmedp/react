...
class TrendingCourseAPI(APIView):
    ...
    def get(self, request, format=None):
        ...
        conversion_ratio_product = Product.objects.order_by('-by_count')[:3]
        revenue_per_mile = Product.objects.all().annotate(
            revenue=(F('buy_count') * F('cp_page_view')) * 1000 / F('cp_page_view'))[:3]
