# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-04-03 06:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('replied_to', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='cms.Comment')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, default='', help_text='The content of the page containing \t\tthe h2 and other content about the product.', verbose_name='Description')),
                ('short_desc', models.TextField(blank=True, default='', help_text='Very short description of the page in about 50 \t\t words', verbose_name='Short Description')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True, null=True)),
                ('last_modified_on', models.DateTimeField(auto_now=True, null=True)),
                ('widget_type', models.PositiveIntegerField(choices=[(1, 'Video with text'), (2, 'Video'), (3, 'Text article'), (4, 'Resume download'), (5, 'Contact us'), (6, 'Related resume'), (7, 'Testimonial'), (8, 'Job'), (9, 'Resume template'), (10, 'Expert section'), (11, 'Recommended courses'), (12, 'Call Back'), (13, 'Share'), (14, 'Custom Job Alert')])),
