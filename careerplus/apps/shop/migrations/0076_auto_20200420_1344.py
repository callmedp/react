    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_section', models.ManyToManyField(blank=True, to='shop.SubSection')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('offer', models.CharField(blank=True, max_length=300, null=True)),
                ('expiry_date', models.DateTimeField(blank=True, null=True)),
                ('max_used', models.PositiveIntegerField(default=100, verbose_name='Maximum number of times this offer can be used')),
                ('active', models.BooleanField(default=False)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='shop_offer_created_by', related_query_name='shop_offers', to=settings.AUTH_USER_MODEL)),
                ('last_modified_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='shop_offer_last_modified_by', related_query_name='shop_offers', to=settings.AUTH_USER_MODEL)),
                ('product', models.ManyToManyField(blank=True, to='shop.Product')),
            ],
            options={
                'ordering': ['-created_on'],
