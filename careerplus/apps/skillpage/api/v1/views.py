...
class SkillPageAbout(APIView):
    ...
    def get(self,request,*args,**kwargs):
        ...
        testimonialcaterories = {}
        for testimonial in testimonialcategory:
            testimonialcaterories.update({
                testimonial.id : testimonialSerializer(testimonial.testimonial).data
                })
        ...
        data.update({
            ...
            'testimonialcategory':testimonialcaterories
        })
