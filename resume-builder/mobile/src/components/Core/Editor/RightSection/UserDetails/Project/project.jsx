...
class Project extends Component {
    ...
    async handleSubmit(values) {
        ...
        let {sidenav:{listOfLinks,currentLinkPos},bulkUpdateUserProject,personalInfo:{order_data},updateCurrentLinkPos,history,updateAlertModalStatus,reGeneratePDF} = this.props
        currentLinkPos++
