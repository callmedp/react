...
class LeftSideBar extends Component {
    ...
    render() {
        ...
        const {formData,ui:{formName,alertModalStatus},personalInfo:{first_name,entity_preference_data,order_data},history,updateAlertModalStatus} = this.props
        let error = false;
        ...
        return (
            <React.Fragment>
                <AlertModal modal_status={alertModalStatus} link={link} history={history} order_data={order_data} newUser={newUser} closeModal={this.closeModal}/>
