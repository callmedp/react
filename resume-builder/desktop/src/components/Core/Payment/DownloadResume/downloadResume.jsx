                    		...
                    		<div className="order-complete">
                    			<ul className="pt-20">
                    				<li>
                						...
                						<strong className="mt-10">An order confirmation has been sent to <b>amit.kumar@gmail.com</b></strong>
                					</li>
                					<li>
                    				...
                    				<li>
	                    				...
	                    				<button className="order-complete--orange-button-change orange-button mt-20 mb-20">Download</button>
                    				</li>
                    			</ul>
                    			<div className="links">
			                		To download your resume anytime later, just visit My Orders on <a href="#"> ShineLearning.com</a>.
			                	</div>
                    		</div>
                    	</section>
