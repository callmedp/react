...
import WatchLeadManagementPage from './LeadManagement/saga';
import WatchLearningTracking from './LearningTracking/saga';
...
export default function* () {
    yield all([
        ...
        WatchFetchUserInfo(),
        WatchDetailPage(),
        WatchLeadManagementPage(),
        WatchLearningTracking(),
    ])
}
