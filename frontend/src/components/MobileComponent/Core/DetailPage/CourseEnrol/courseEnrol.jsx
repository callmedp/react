            ...
            <section className="m-container mt-80n mb-0 pb-0">
                <div className="m-course-enrol" itemProp="offers" itemScope itemType="http://schema.org/Offer">
                    ...
                    <div className="m-course-enrol__price">
                        ...
                        <Link to={'#'} className="btn btn-secondary mt-10 ml-auto" onClick={() => goToCart(varChecked)}> { product_detail?.prd_service === 'assessment' ? 'Buy Now' : product_detail?.redeem_test ? 'Redeem Now' : 'Buy now' }</Link>
                    </div>
