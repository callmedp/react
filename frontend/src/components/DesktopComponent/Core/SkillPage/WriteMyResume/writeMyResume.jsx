    ...
    return (
        <section className="write-resume" data-aos="fade-up">
            ...
            <figure className="write-resume__img" data-aos="fade-in">
                ...
                <span className="resume-tween1" data-aos="fade-up" data-aos-easing="ease-in-back" data-aos-offset="0" data-aos-delay="100">
                    <img src={`${imageUrl}desktop/resume-tween1.png`} />
                </span>
                <span className="resume-tween2" data-aos="fade-right" data-aos-easing="ease-in-back" data-aos-offset="0" data-aos-delay="200">
                    <img src={`${imageUrl}desktop/resume-tween2.svg`} />
                </span>
                <span className="resume-tween3" data-aos="fade-left" data-aos-easing="ease-in-back" data-aos-offset="0" data-aos-delay="300">
