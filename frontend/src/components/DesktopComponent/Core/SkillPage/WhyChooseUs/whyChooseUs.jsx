    ...
    return (
        ...
        <div className="container">
            <div className="row align-items-center flex-column">
                ...
                <ul>
                    <li className="col">
                        <figure data-aos="fade-up" data-aos-delay="10" className="icon-choose1"></figure>
                        <strong data-aos="fade-up" data-aos-delay="30">36000+ Jobs</strong>
                        <p data-aos="fade-up" data-aos-delay="50" >opportunities on shine</p>
                    </li>
                    <li className="col">
                        <figure data-aos="fade-up" data-aos-delay="70" className="icon-choose2"></figure>
                    ...
                    <li className="col">
                        <figure data-aos="fade-up" data-aos-delay="130" className="icon-choose3"></figure>
                    ...
                    <li className="col">
                        <figure data-aos="fade-up" data-aos-delay="190" className="icon-choose4"></figure>
                    ...
                    <li className="col">
                        <figure data-aos="fade-up" data-aos-delay="250" className="icon-choose5"></figure>
                    ...
                    <li className="col">
                        <figure data-aos="fade-up" data-aos-delay="310" className="icon-choose6"></figure>
