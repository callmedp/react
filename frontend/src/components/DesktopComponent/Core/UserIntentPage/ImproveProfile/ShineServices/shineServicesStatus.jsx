                        ...
                        <div className="shine-services w-70">
                            ...
                            <span className="fs-13">
                                ...
                                <span className="d-flex mt-20">
                                    ...
                                    <Link className="file-close" to={"#"}>Mylatestresume.pdf <i className="icon-close-sm ml-10"></i></Link>
                                </span>
                            </span>
                        </div>
                        <div className="shine-services w-70">
            ...
            >
                ...
                <Modal.Body>
                    ...
                    <form className="mt-30">
                        ...
                        <input type="file" className="form-control btn btn-primary-outline" />
                        
                        <span>File size should not exceed 3MB. in .doc, PDF, Jpeg format only</span>
