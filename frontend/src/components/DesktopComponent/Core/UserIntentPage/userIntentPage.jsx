                ...
                {
                    {
                        ...
                        'improve-profile': <ImproveProfile icon="icon-ui3" title="Improve your profile" back={true}/>,
                        'progress-career': <ProgressCareer icon="icon-ui4" title="Progress your career" back={true} {...props}/>,
