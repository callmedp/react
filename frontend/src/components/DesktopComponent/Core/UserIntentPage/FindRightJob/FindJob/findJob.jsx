                                        ...
                                        <div className={chips?.length ? "form-group-custom checked" : !!errors ? "form-group-custom error" : "form-group-custom"}>
                                            ...
                                            <div className="custom-textarea">
                                                ...
                                                <span className="d-flex align-items-center mt-10">
                                                    <input type="text" className="form-control custom-input" name="skills" placeholder="Enter Skills" id="skills" autoComplete="off" ref={skillsKey} onChange={ e => suggestSkills(e) } onFocus={() => setShowSkillResults(true)} />
