    ...
    const getSlide = (recruiterSlide) => recruiterSlide.slice(0,12)?.map((skill, index) => {
        return (
            ...
            <Link to={skill.skillUrl}>
                <div className="card" onClick={() => MyGA.SendEvent('ln_new_homepage', 'ln_recruiter_course', ' ln_click_course', skill.name, '', false, true)}>
                    <figure>
                    ...
                    <Link to={skill.skillUrl} onClick={() => MyGA.SendEvent('ln_new_homepage', 'ln_recruiter_course', ' ln_click_course', skill.name, '', false, true)}>Know more</Link>
                </div>
            </Link>
            </li>
        )
