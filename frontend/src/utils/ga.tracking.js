...
gtag('config', 'UA-3537905-54');
gtag('config', 'UA-3537905-1',{'group':'mainProfile'});
...
function GA(){
    ...
    that.sendVirtualPage = function(obj){
        ...
        gtag('event', 'page_view',{'send_to': event_id,'page_title':pageTitle,'page_location':window.location.href,'page_path':window.location.pathname});
    };
