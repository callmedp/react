...
import '../JAlandingPage/JAlandingPage.scss';
import HeaderJAlandingPage from '../DesktopComponent/Common/Header/headerjalandingpage';
import Footer from '../DesktopComponent/Common/Footer/footerjalandingpage';

const JAlandingPage = (props) => {
    return (
        <div>
            <HeaderJAlandingPage />
